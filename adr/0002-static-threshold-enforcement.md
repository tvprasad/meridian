...
Meridian v0 enforces a static retrieval confidence threshold. If retrieval\_max\_score < threshold, Meridian refuses generation with HTTP 422 and returns diagnostics.
