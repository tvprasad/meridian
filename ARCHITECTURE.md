...
- HTTP failure semantics + confidence_score
...
- confidence_score is retrieval-derived (v0: retrieval_max_score)
- Every request produces trace_id and telemetry event